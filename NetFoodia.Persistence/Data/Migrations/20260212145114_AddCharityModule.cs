...
{
    /// <inheritdoc />
    public partial class AddCharityModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharityAdminProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharityAdminProfiles_Charities_CharityId",
                        column: x => x.CharityId,
                        principalTable: "Charities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharityAdminProfiles_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Charities_OrganizationName",
                table: "Charities",
                column: "OrganizationName");

            migrationBuilder.CreateIndex(
                name: "IX_CharityAdminProfiles_CharityId",
